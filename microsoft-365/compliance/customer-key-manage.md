...
### Revoke your Customer Keys and the availability key/Managed Key for SharePoint Online, OneDrive for Business, and Teams files

To revoke customer key - both availability key and managed key, one will need to exit the service and delete the subscrptions for the SPO tenant 
